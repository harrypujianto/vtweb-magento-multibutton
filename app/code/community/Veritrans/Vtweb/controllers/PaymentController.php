...
class Veritrans_Vtweb_PaymentController
  ...
  public function redirectAction() {
    ...
    //$payment_method = Mage::registry('payment_method');
     ...
     error_log('$paymentcode = '.$paymentcode);
    ...
    $vtweb_enable = Mage::getStoreConfig('payment/vtweb/active');
    $payloads = array();
    $payloads['transaction_details'] = $transaction_details;
    $payloads['item_details']        = $item_details;
    $payloads['customer_details']    = $customer_details;
    $payloads['vtweb']               = ($paymentcode == 'vtweb') ?
                                        array('enabled_payments'=> 'credit_card') : array('enabled_payments'=> $paymentcode);
