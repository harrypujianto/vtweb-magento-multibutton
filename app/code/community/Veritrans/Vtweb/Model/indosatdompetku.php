 ...
 */
class Veritrans_Vtweb_Model_Indosatdompetku extends Veritrans_Vtweb_Model_Abstract {

	protected $_code = 'indosat_dompetku';
	protected $_paymentMethod	= 'indosat_dompetku';
}
?>
